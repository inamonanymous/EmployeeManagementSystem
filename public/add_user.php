    ...
    <div class="w-11/12 flex bg-white shadow-2xl rounded-lg">
        ...
        <div class="bg-slate-100 rounded-tr-lg rounded-br-lg w-[80%]">
            <div class="w-11/12 mx-auto mt-10">
                <h1 class="mb-10 text-lg font-semibold">Add User</h1>
                        ...
                        <div class="w-full mb-10">
                            <div class="w-full flex gap-10 mb-5 wrap">
                                ...
                                <div class="w-full flex items-center gap-5">
                                    ...
                                    <input type="email" id="email" name="email" class="px-1 py-2 w-full">
                                </div>
                                <div class="w-full flex items-center gap-5">
                                    <label for="password">Password</label>
                                    <input type="password" id="password" name="password" class="px-1 py-2 w-full">
                                </div>
                                <div class="w-full flex items-center gap-5">
                                    <label for="password2">Re-enter Password</label>
                                    <input type="password" id="password2" name="password2" class="px-1 py-2 w-full">
                                </div>
                                <div class="w-full flex items-center gap-5">
                                    <label for="type">Account Type</label>
                                    <select type="text" id="type" name="type" class="px-1 py-2 w-full"> 
