    ...
    <div class="w-11/12 flex bg-white shadow-2xl rounded-lg">
        ...
        <div class="bg-slate-100 rounded-tr-lg rounded-br-lg w-[80%]">
            <div class="w-11/12 mx-auto mt-10">
                <h1 class="mb-4 text-lg font-semibold">Users List</h1>
                <button onclick="window.location.href='add_user.php'" class="px-6 py-1 bg-main-2 text-white float-right mb-10">Add</button>
                <div>
                    <table class="w-full text-center">
                        ...
                        <tr class="bg-slate-200">
                            ...
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                ...
                                <td><?php echo ($row['type'] == 1 ? "Administrator" : "Human Resource") ?></td>
                                <td>
