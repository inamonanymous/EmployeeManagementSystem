        ...
        if (isset($_POST['add'])) {
           /*$c_id = $_POST['c_id'];
            ...
            while ($current_date <= $end_date) {
                ...
                $stmt = $con->prepare("INSERT INTO attendance (c_id, curr_date, hours, is_leave) VALUES (?, ?,  8, 1)");
                $stmt->bind_param("ss", $c_id, $date_str);
                if ($stmt->execute()) {
                    header("Location: attendance.php");
                    echo "New record created successfully";
                } else {
    ...
    <div class="w-11/12 flex bg-white shadow-2xl rounded-lg">
        ...
        <div class="bg-slate-100 rounded-tr-lg rounded-br-lg w-[80%]">
            <div class="w-11/12 mx-auto mt-10">
                <h1 class="mb-10 text-lg font-semibold">Add Sick/Vacation Leave</h1>
                        ...
                        <div class="w-full mb-10">
                            <div class="w-full flex gap-10 mb-5 wrap">
                                ...
                                <div class="w-full flex items-center gap-5">
                                    ...
                                    <div class="flex items-center gap-5 text-sm">
                                        <label for="time">Ending Date</label>
