...
<body class="grid place-items-center min-h-screen bg-slate-100">
    <div class="w-2/3 flex bg-white shadow-2xl rounded-lg">
        ...
        <div class="bg-slate-100 rounded-tr-lg rounded-br-lg w-[80%]">
            <div class="bg-slate-200 flex items-center py-1 mb-10">
            ...
            <div class="w-11/12 mx-auto">
                <h1 class="mb-4 text-lg font-semibold">Employees List</h1>
                <div>
