<?php
    ...
    $delete = "DELETE FROM users WHERE id = ? AND type = 0";
    ...
    if($stmt = mysqli_prepare($con, $delete)){
        ...
        if(mysqli_stmt_execute($stmt)){
            header('location: users.php'); // Redirect to a confirmation page or elsewhere after deleting.
        } else {
            echo 'Error: Cannot delete admin type';
        }
